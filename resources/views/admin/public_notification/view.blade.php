            ...
            <div class="portlet">
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-12" align="center">
                                <div class="btn-group">
                                    <a href="{{url(admin_vw().'/send-pub-notification')}}" class="btn sbold green send-public-notification">
                    ...
                    <div class="table-scrollable">
                        <table class="table table-striped table-bordered table-advance table-hover" id="send-pub-notification_tbl">
                            <thead>
                            <tr>
                                <th>
                                    #
    ...
    @push('js')
        <script>
            ...
            $(document).ready(function () {
                ...
                var table = $('#send-pub-notification_tbl').DataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": baseURL + '/admin/public-notification-data',
                    columns: [
...
//
                ...
                $(document).on('click', '.send-public-notification', function (e) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('#send-public-notification').modal('show');
                        }
                    });
                });
