var Login = function () {
    var e = function () {
        $(".login-form").validate({
            ...
            messages: {username: {required: "اسم المستخدم مطلوب."}, password: {required: "كلمة المرور مطلوبة."}},
    ...
    return {
        init: function () {
            e(), r(), s(), $.backstretch(["../assets/pages/media/bg/1.jpg", "../assets/pages/media/bg/2.jpg", "../assets/pages/media/bg/3.jpg", "../assets/pages/media/bg/4.jpg"], {
                fade: 1e3,
                duration: 8e3
            })
        }
